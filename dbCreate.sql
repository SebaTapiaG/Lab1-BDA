...
CREATE TABLE Orden (
                       ...
                       estado VARCHAR(50) NOT NULL, -- Estado de la orden
...
CREATE TABLE Detalle_Orden (
                               ...
                               estado VARCHAR(50) NOT NULL, -- Estado del detalle de la orden
...
CREATE TABLE Query_Log (
                           ...
                           name VARCHAR(255) NOT NULL,        -- Nombre asociado a la query
                           actual_timestamp TIMESTAMP NOT NULL, -- Timestamp actual de la query
                           query_type CHAR(50) NOT NULL,      -- Tipo de la query
                           query_statement TEXT NOT NULL     -- Sentencia de la query
);
